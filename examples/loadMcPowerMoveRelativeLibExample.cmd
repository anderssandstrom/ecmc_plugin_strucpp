# Example IOC shell snippet for the ST-based move-relative motion sample.
#
...
epicsEnvSet(STRUCPP_LOGIC_LIB,"/absolute/path/to/mc_power_move_relative_lib_logic.so")
