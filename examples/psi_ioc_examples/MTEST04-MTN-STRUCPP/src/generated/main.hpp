...
// Forward: ACTUAL_POSITION AT %IW0 in Program_MAIN
// Forward: DRIVE_CONTROL AT %QW0 in Program_MAIN
// Forward: VELOCITY_SETPOINT AT %QW2 in Program_MAIN
// Forward: CYCLE_COUNTER AT %MW0 in Program_MAIN

extern LocatedVar locatedVars[4];
constexpr uint32_t locatedVarsCount = 4;
