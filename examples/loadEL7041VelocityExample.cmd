...
# are literal. If you change the slave id, update the mapping file contents too.

epicsEnvSet(STRUCPP_LOGIC_LIB,"/absolute/path/to/el7041_velocity_logic.so")
epicsEnvSet(STRUCPP_MAPPING_FILE,"$(ecmc_plugin_strucpp_DIR)examples/el7041_velocity.map")
