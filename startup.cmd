...
#else
  ${STRUCPP_CORE_SKIP_FALSE}ecmcIf("${DB_MACROS=__EMPTY__}=__EMPTY__",STRUCPP_CORE_DB_EMPTY_TRUE,STRUCPP_CORE_DB_EMPTY_FALSE)
...
#else
  ${STRUCPP_APP_SKIP_FALSE}ecmcIf("${EPICS_SUBST=__EMPTY__}=__EMPTY__",STRUCPP_APP_SUBST_EMPTY_TRUE,STRUCPP_APP_SUBST_EMPTY_FALSE)
  ${STRUCPP_APP_SUBST_EMPTY_TRUE}ecmcIf("${DB_PREFIX=__EMPTY__}=__EMPTY__",STRUCPP_DB_PREFIX_EMPTY_TRUE,STRUCPP_DB_PREFIX_EMPTY_FALSE)
    ${STRUCPP_DB_PREFIX_EMPTY_TRUE}ecmcIf("${DB_MACROS=__EMPTY__}=__EMPTY__",STRUCPP_DB_MACROS_EMPTY_TRUE_1,STRUCPP_DB_MACROS_EMPTY_FALSE_1)
# no EPICS record file requested
  ...
  #else
    ${STRUCPP_DB_PREFIX_EMPTY_FALSE}ecmcIf("${DB_MACROS=__EMPTY__}=__EMPTY__",STRUCPP_DB_MACROS_EMPTY_TRUE_2,STRUCPP_DB_MACROS_EMPTY_FALSE_2)
...
#else
  ${STRUCPP_APP_SUBST_EMPTY_FALSE}ecmcIf("${DB_MACROS=__EMPTY__}=__EMPTY__",STRUCPP_DB_MACROS_EMPTY_TRUE_3,STRUCPP_DB_MACROS_EMPTY_FALSE_3)
